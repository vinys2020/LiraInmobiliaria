...
export default function RecibosInquilinoModal({
  mostrarRecibosInquilino,
  setMostrarRecibosInquilino,
  contratoRecibosInquilino
}) {
...
const filtrados = data.filter((r) => {
  ...
  const propiedadMatch =
    r.propiedadTitulo === contratoRecibosInquilino?.propiedadTitulo;
          ...
          <div className="modal-content">
            ...
            <div className="modal-header">
              ...
              <h5 className="modal-title">
                HISTORIAL DE RECIBOS DEL INQUILINO
              </h5>

              <button
                className="btn-close"
                onClick={() =>
                  setMostrarRecibosInquilino(false)
                }
              />
