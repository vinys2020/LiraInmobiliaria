...
const CardSeleccionPropiedad = ({ propiedad, onSelect }) => {
  ...
  const formatPrecio = (precio, moneda) => {
    ...
    return `${getMonedaSimbolo(moneda)} ${Number(
      precio
        ...
        <div className="card-body d-flex flex-column p-4">
          ...
          {propiedad.direccion && (
            <div className="mb-0 mt-auto">
              <div className="text-muted small d-flex align-items-start">
...
export default CardSeleccionPropiedad;
